...
function parseContent(content) {
	...
	res.props.render = (codeblock) => {
		...
		if (typeof res.props.children.props.children === "string") {
			...
			const props =
				res.props.children.props.children.props.children[1].props;
...
// Might as well.
module.exports = KLibrary?.Tools?.ReactTools?.WrapBoundary
	? KLibrary.Tools.ReactTools.WrapBoundary(ViewRawModal)
	: ViewRawModal;
